...
class Gw2ApiFacadeTest(TestCase):
    ...
    def test_guild_search(self):
        guildId = bot.gw2_api.guild_search("Lqibzzexgvkikpydotxsvijehyhexd")
        self.assertEqual(guildId, "14762DCE-C2A4-E711-80D5-441EA14F1E44")

    def test_guild_search_no_result(self):
        guildId = bot.gw2_api.guild_search("aadafddfggfadasd")
        self.assertIsNone(guildId)

    def test_get_guild_info(self):
        guild_info = bot.gw2_api.guild_get("14762DCE-C2A4-E711-80D5-441EA14F1E44")
    ...
    def test_get_guild_info_wrong_id(self):
        with self.assertRaises(bot.gw2_api.ApiError):
            bot.gw2_api.guild_get("bad-id-that-is-made-up")

    def test_get_account_info(self):
        account_info = bot.gw2_api.account_get(self.TEST_TOKEN)
    ...
    def test_get_account_info_bad_key(self):
        with self.assertRaises(bot.gw2_api.ApiError, msg="Invalid access token"):
            bot.gw2_api.account_get("qdasdasd-asdasd-as-d-asd-a-sd")

    def test_get_characters(self):
        characters = bot.gw2_api.characters_get(self.TEST_TOKEN)
    ...
    def test_get_worlds_by_ids(self):
        worlds = bot.gw2_api.worlds_get(ids=[2202])
    ...
    def test_get_one_world_by_id(self):
        world = bot.gw2_api.worlds_get_one(2202)
