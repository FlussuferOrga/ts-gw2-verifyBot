...
class English(Locale):
    def __init__(self):
        ...
        self.set("bot_msg_success",
                 "Authentication was succesful! Thank you fellow adventurer. Please give our rules a read and have fun \\(^.^)/ If you don't see any people, please relog once.")
        ...
        self.set("bot_msg_verification_currently_not_possible",
                 "Unfortunately we are currently not able to verify you. Ask the TeamSpeak admin for assistance")
        ...
        self.set("bot_msg_sguild_nv",
                 "I'm sorry, I can't help you set guild tags unless you are authenticated. Please verify first by replying to me with your API key." + self.get(
                     "bot_msg_example") + self.get(
                     "bot_msg_note"))

        # Message sent to someone who is verified and asks to set guild tags.
        self.set("bot_msg_sguild",
                 "Let's get to work! First, I need your API key. Reply back with your API key:" + self.get(
        ...
        self.set("bot_msg_gld_needs_auth",
                 "Were you trying to change your guild tags? If so, please be aware you have not been verified yet! Read below to verify." + self.get(
                     "bot_msg_example"))

        # Base Message sent to someone who gave us the API key to pull guild tags.
        self.set("bot_msg_gld_lis",
                 "API Authentication succeeded. Session built. Here are your guild TAGS your can choose to assign:")
        ...
        self.set("bot_hide_guild_success",
                 "Okay, I will not give you this tag again upon revalidation. You can [b]unhideguild[/b] the tag at any time.")

        # User passed an invalid guild
        self.set("bot_hide_guild_unknown",
                 "Sorry, there seems to be no such guild or you have already hidden it. Please make sure you use the exact spelling that is used for the TS group.")
        ...
        # User successfully hid a guild
        self.set("bot_unhide_guild_success",
                 "Okay, you will receive this group with the next revalidation, if you are entitled to get it.")

        # User passed an invalid guild
        self.set("bot_unhide_guild_unknown",
                 "Sorry, there seems to be no such guild-group or you have not hidden it. Please make sure you use the exact spelling that is used for the TS group.")

        self.set("bot_pong_response", "Pong! I'm still alive!")

        self.set("bot_msg_verification_disabled", "Verification is currently disabled.")
